...
Welcome to the party! Tournament Manager explains things in admin notices, so you might not see them if you have notices hidden with a third-party plugin like [https://wordpress.org/plugins/admin-site-enhancements/](Admin & Site Enhancements). On the upside, you can enable a third-party plugin like ASE to hide notices if you no longer wish to see them. I recommend something like [https://wordpress.org/plugins/unnotifier/](Unnotifier) to dismiss individual notices rather than the all or nothing approach like what's in ASE and others.
